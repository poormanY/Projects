...
CString strLImagePath;

CLeftImg::CLeftImg(CWnd* pParent /*=NULL*/)
	: CDialog(CLeftImg::IDD, pParent)
{
...
void CLeftImg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLeftImg, CDialog)
...
void CLeftImg::DrawImage(CDC *pDC)
{

	CImage Image;
	CClientDC dc(this);
	//	CPaintDC dc(this);
	HRESULT hresult = Image.Load(strLImagePath);
...
int CLeftImg::LeftDraw(CString Name, unsigned int StartNumber, unsigned int StopNumber)
{
	CImage Image;
	CClientDC dc(this);
