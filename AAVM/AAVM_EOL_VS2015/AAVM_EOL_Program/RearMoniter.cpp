...
CString strReImagePath;

CRearImg::CRearImg(CWnd* pParent /*=NULL*/)
	: CDialog(CRearImg::IDD, pParent)
{
...
void CRearImg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CRearImg, CDialog)
...
void CRearImg::DrawImage(CDC *pDC)
{

	CImage Image;
	CClientDC dc(this);
	//	CPaintDC dc(this);
	HRESULT hresult = Image.Load(strReImagePath);
...
int CRearImg::RearDraw(CString Name, unsigned int StartNumber, unsigned int StopNumber)
{
	CImage Image;
	CClientDC dc(this);
